...
const benefits = [
  ...
  },
  {
    ...
    title: 'Truly Personalised Pathways',
    description:
      'No two children are alike. We build each learning plan around your child\'s unique strengths, interests, challenges, and pace.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    description:
      'Clear milestones, regular check-ins, and transparent reporting so you can see your child\'s growth — and celebrate every win.',
  },
]
...
function BenefitCard({ benefit, index }) {
  ...
  return (
    ...
    >
      <div className="w-12 h-12 rounded-xl bg-sage/8 flex items-center justify-center text-sage mb-6 group-hover:bg-sage group-hover:text-white transition-all duration-500">
        {benefit.icon}
      </div>
  ...
  return (
    <section className="py-24 lg:py-36 bg-cream">
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        ...
        {/* Benefits Grid — magazine-inspired asymmetric layout */}
