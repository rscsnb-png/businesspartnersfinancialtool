...
const benefits = [
  ...
  },
  {
    ...
    title: 'Homeschool & Mainstream Support',
    description:
...
function BenefitCard({ benefit, index }) {
  ...
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-2xl p-8 lg:p-10 shadow-[0_1px_3px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-shadow duration-500"
    >
      <div className="w-12 h-12 rounded-xl bg-blue/8 flex items-center justify-center text-blue mb-6 group-hover:bg-blue group-hover:text-white transition-all duration-500">
        {benefit.icon}
      </div>
...
export default function Solution() {
  ...
  return (
    <section className="py-24 lg:py-36 bg-beige">
